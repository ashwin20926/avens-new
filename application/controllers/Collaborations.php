...
class Collaborations extends CI_Controller {
  ...
  if ( ! file_exists(APPPATH.'views/pages/collaborations.php'))
	        ...
	        $data['keywords'] = "scientific collaboration, university collaboration, institute collaboration, laboratory collaboration";
