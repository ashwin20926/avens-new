			...
			<div>
				...
				<?php 
					if($eb_info[0]['issn_number']) {
						echo "<div class='issn-num'><p>[ISSN: ".$eb_info[0]['issn_number']."]</p></div>";
					}
				?>
					<div id="journal-sidebar">
						<div id="nav-post">
							...
							/*
								foreach ($static_page as $key => $value) {
									echo '<li><a class="" href="'.base_url().''.strtolower($eb_info[0]['category_name']).'/'.$eb_info[0]['journal_url_slug'].'/'.$value.'/">'.$key.'</a></li>';
								}
							*/
